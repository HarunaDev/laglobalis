    ...
    <section className="min-h-[85%] md:min-h-[80dvh] lg:min-h-screen mt-24 md:mt-0 flex items-center justify-center text-center pt-20 px-8 md:px-12 lg:px-20 overflow-hidden">
      <div>
        ...
        <div className="mt-10 flex gap-4 justify-center items-center">
          <button className="bg-primaryColor lg:w-full sm:w-auto text-secondaryColor px-6 py-3 rounded-lg hover:scale-95 transition-all">
            Explore
          </button>
          <button className="border border-[#D4AF37] px-6 py-3 lg:w-full sm:w-auto rounded-lg text-[#D4AF37] hover:scale-95 transition-all">
            Discover
          </button>
        </div>
      </div>
